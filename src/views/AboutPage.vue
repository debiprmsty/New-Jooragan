<template>
    <div class="font-poppins min-h-screen mt-24 bg-white">
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div class="grid gap-10 lg:grid-cols-2">
              <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                <div class="flex items-center justify-center mx-auto w-44 h-44 mb-4 rounded-full bg-teal-accent-400 ">
                    <img src="../assets/images/logo.png" alt="" srcset="" class="md:w-44 md:h-44">
                </div>
                <div class="max-w-xl mb-6">
                  <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none text-center">
                    Inovasi yang Mewujudkan <br class="hidden md:block" />
                    Impian Anda.
                  </h2>
                  <p class="text-base text-gray-700 md:text-lg text-center">
                    Platform berbasis mobile apps dan website yang mempermudah Anda pada bidang franchise
                  </p>
                </div>
              </div>
        ...
        <h2 class=" mb-12 font-sans md:text-5xl text-3xl  text-center font-bold tracking-tight text-amber-500 sm:leading-none">
            Mengapa memilih Jooragan ?
        </h2>
        ...
        <div class="grid gap-8 row-gap-5 lg:grid-cols-3">
            <div class="relative p-px overflow-hidden transition duration-300 transform border rounded-xl shadow-sm hover:scale-105 group hover:shadow-xl">
            ...
            <div class="relative p-5 bg-zinc-800 rounded-xl">
