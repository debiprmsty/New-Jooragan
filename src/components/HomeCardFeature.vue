<template>
        <div class="relative sm:h-96 mt-16">
            ...
            <div class="absolute inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
              <h1 class="text-4xl sm:text-6xl font-bold text-amber-500">Kata-kata promosi franchise</h1>
            </div>
        </div>
          
        <div class="px-4 py-16 mx-auto sm:max-w-full md:max-w-full lg:max-w-full md:px-24 lg:px-8 lg:py-20">
            <div class="grid gap-5 row-gap-5 mb-8 lg:grid-cols-4 sm:grid-cols-2 ml-4 md:ml-0">
            <div class="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:-translate-y-2">
                <img class="object-cover w-full h-48 mt-2 rounded-lg" src="../assets/images/p1.jpg" alt="NIKE AIR">
                <div class="px-4 py-2">
