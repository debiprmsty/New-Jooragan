      ...
      <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-2">
        ...
        <div class="sticky top-0">
          ...
          <div class="mt-8 flex justify-between">
            ...
            <p class="text-lg font-bold">Rp 1.000.0000</p>
          </div>
  
          <div class="mt-4">
            <div class="prose max-w-none">
              <p>
                Dengan bergabung sebagai mitra franchise kami, Anda akan mendapatkan dukungan penuh dalam menjalankan bisnis kopi yang sukses, memanfaatkan brand yang terkenal, sistem yang teruji, dan jaringan yang kuat. 
              </p>
            </div>
