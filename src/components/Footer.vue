<template>
    <div class="relative mt-16 bg-amber-500">
      <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-zinc-800" preserveAspectRatio="none" viewBox="0 0 1440 54">
        ...
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div class="md:max-w-md lg:col-span-2">
            <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
              ...
              <span class="ml-2 text-xl font-bold tracking-wide text-zinc-800 uppercase">Jooragan</span>
            </a>
            <div class="mt-4 lg:max-w-sm">
              ...
              <h4 class="mt-4 text-sm text-deep-purple-50 font-bold">
                SAATNYA JADI JOORAGAN!
              </h4>
            </div>
          </div>
